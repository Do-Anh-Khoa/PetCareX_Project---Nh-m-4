namespace PetCare_WinForm
{
    partial class Lich_Hen
    {
        ...
        private void InitializeComponent()
        {
            ...
            pnlHeader.Controls.Add(lbl_ThongTin);
            ...
            // lbl_ThongTin
            // 
            lbl_ThongTin.Dock = DockStyle.Right;
            lbl_ThongTin.Font = new Font("Segoe UI Semibold", 16F, FontStyle.Bold);
            lbl_ThongTin.ForeColor = SystemColors.ButtonHighlight;
            lbl_ThongTin.Location = new Point(757, 0);
            lbl_ThongTin.Name = "lbl_ThongTin";
            lbl_ThongTin.Size = new Size(368, 93);
            lbl_ThongTin.TabIndex = 4;
            lbl_ThongTin.Text = "--- / ----";
            lbl_ThongTin.TextAlign = ContentAlignment.MiddleRight;
            // 
            // lblTitle
            // 
            ...
            pnlButtons.Controls.Add(btn_ChamCong);
            ...
            // btn_ChamCong
            // 
            btn_ChamCong.BackColor = Color.Silver;
            btn_ChamCong.FlatStyle = FlatStyle.Flat;
            btn_ChamCong.Font = new Font("Segoe UI", 10F, FontStyle.Bold);
            btn_ChamCong.ForeColor = Color.Black;
            btn_ChamCong.Location = new Point(532, 17);
            btn_ChamCong.Margin = new Padding(3, 4, 3, 4);
            btn_ChamCong.Name = "btn_ChamCong";
            btn_ChamCong.Size = new Size(137, 51);
            btn_ChamCong.TabIndex = 4;
