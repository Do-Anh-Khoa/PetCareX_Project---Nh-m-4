...
namespace PetCare_WinForm
{
    partial class FrmHome
    {
        ...
        private void InitializeComponent()
        {
            ...
            pnlSidebar.Controls.Add(btnDuyetLich);
            pnlSidebar.Controls.Add(pnlLogo);
            pnlSidebar.Controls.Add(lblNhanVienInfo);
            ...
            btnChamCong.Location = new Point(0, 360);
            btnChamCong.Name = "btnChamCong";
            btnChamCong.Padding = new Padding(20, 0, 0, 0);
            btnChamCong.Size = new Size(250, 60);
            ...
            // lblNhanVienInfo
            // 
            lblNhanVienInfo.Dock = DockStyle.Bottom;
            lblNhanVienInfo.Font = new Font("Segoe UI", 12F, FontStyle.Bold);
            lblNhanVienInfo.ForeColor = Color.White;
            lblNhanVienInfo.Location = new Point(0, 488);
            lblNhanVienInfo.Name = "lblNhanVienInfo";
            lblNhanVienInfo.Size = new Size(250, 52);
            lblNhanVienInfo.TabIndex = 101;
            lblNhanVienInfo.Text = "Nhân viên: \r\nMã NV: ";
            lblNhanVienInfo.TextAlign = ContentAlignment.MiddleLeft;
            // 
            // btnDangXuat
            // 
