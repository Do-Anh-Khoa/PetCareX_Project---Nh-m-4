...
namespace PetCare_WinForm
{
    partial class FrmBaoCao : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            // --- 1. Bộ lọc Năm (Vị trí cũ) ---
            lblChonNam = new Label { Text = "Năm:", AutoSize = true, Location = new Point(20, 20) };
            cboNam = new ComboBox { Location = new Point(70, 17), Size = new Size(100, 25), DropDownStyle = ComboBoxStyle.DropDownList };

            // --- 2. Bộ lọc Tháng (MỚI THÊM) ---
            // Đặt ngay sau ComboBox Năm
            lblChonThang = new Label { Text = "Tháng:", AutoSize = true, Location = new Point(190, 20) };
            cboThang = new ComboBox { Location = new Point(240, 17), Size = new Size(100, 25), DropDownStyle = ComboBoxStyle.DropDownList };

            // --- 3. Bộ lọc Chi Nhánh (Dời sang phải) ---
            lblChonCN = new Label { Text = "Chi Nhánh:", AutoSize = true, Location = new Point(360, 20) };
            cboChiNhanh = new ComboBox { Location = new Point(440, 17), Size = new Size(200, 25), DropDownStyle = ComboBoxStyle.DropDownList };

            // --- 4. Nút Lọc (Dời sang phải) ---
            btnXemBaoCao = new Button 
            { 
                Text = "Lọc Dữ Liệu", 
                Size = new Size(120, 30), 
                Location = new Point(660, 15), // Dời vị trí X ra xa hơn
                BackColor = Color.DodgerBlue, 
                ForeColor = Color.White 
            };
            btnXemBaoCao.Click += new System.EventHandler(this.BtnXemBaoCao_Click);
            ...
            // Add Tháng
            panelTop.Controls.Add(lblChonThang);
            panelTop.Controls.Add(cboThang);
            ...
            // 3. ADD VÀO FORM
            // ========================================================
            this.Controls.Add(tabControlBaoCao); 
