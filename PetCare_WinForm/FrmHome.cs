...
namespace PetCare_WinForm
{
    public partial class FrmHome : Form
    {
        ...
        {
            if (!string.IsNullOrEmpty(UserSession.MaNhanVien))
            {
                lblNhanVienInfo.Text = $"Nhân viên: {UserSession.TenNhanVien}\r\nMã NV: {UserSession.MaNhanVien}";
            }
            else
            {
                lblNhanVienInfo.Text = "Nhân viên: N/A\r\nMã NV: N/A";
            }
        }
