...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-ORDALAOG\\SQLEXPRESS;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
       ...
       modelBuilder.Entity<BangLuongThang>(entity =>
            {
            // 1. Khóa chính
            entity.HasKey(e => new { e.MaNv, e.Thang, e.Nam })
            ...
            entity.Property(e => e.NgayTinhLuong)
                ...
                .HasConversion(
                    // Chuyển từ DateOnly? sang DateTime? để lưu vào DB
                    v => v.HasValue ? v.Value.ToDateTime(TimeOnly.MinValue) : (DateTime?)null,
                    // Chuyển từ DateTime? trong DB về DateOnly? để dùng trong code
